...
contract OracleHub is Ownable, ReentrancyGuard {
     ...
     */
    function _calculateNumericConsensus(Response[] storage responses) internal view returns (bytes memory) {
     ...
     */
    function _calculateModeConsensus(Response[] storage responses) internal view returns (bytes memory) {
